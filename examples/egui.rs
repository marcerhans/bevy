//! Source: https://raw.githubusercontent.com/mvlabat/bevy_egui/v0.15.0/examples/ui.rs
//! (With some changes, i.e. no images.)
...
fn update_ui_scale_factor(
    ...
    if keyboard_input.just_pressed(KeyCode::K) || toggle_scale_factor.is_none() {
